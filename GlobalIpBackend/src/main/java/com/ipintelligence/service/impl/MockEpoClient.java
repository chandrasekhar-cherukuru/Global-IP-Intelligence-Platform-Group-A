...
@Service
@Slf4j
//public class MockEpoClient implements PatentOfficeApiClient {
public class MockEpoClient {

//    private final MockDataService mockDataService;
//
//    public MockEpoClient(MockDataService mockDataService) {
//        this.mockDataService = mockDataService;
//    }
//
//    @Override
//    public SearchResultDto search(SearchRequestDto request) {
//        log.info("MOCK EPO: Searching for query: {}", request.getQuery());
//
//        SearchResultDto result = new SearchResultDto();
//        result.setDataSource("EPO_MOCK");
...
//                request.getQuery(), "EPO", mockResultCount
//        ));
//
...
//
//        log.info("MOCK EPO: Returned {} results", mockResultCount);
//
//        return result;
//    }
//
...
//        log.info("MOCK EPO: Fetching details for {}", externalId);
//        return mockDataService.generateMockPatents(externalId, "EPO", 1).get(0);
//    }
//
//    @Override
